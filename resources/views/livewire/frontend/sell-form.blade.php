<section id="form-penjualan" aria-labelledby="form-heading"
    class="bg-brand-soft pt-20 pb-24 md:pt-28 md:pb-32 z-30 relative rounded-t-3xl md:rounded-t-[2.5rem] -mt-6 md:-mt-10">
    <div class="max-w-4xl mx-auto px-6 lg:px-12">
        <div
            class="bg-white border border-gray-200 rounded-3xl p-5 sm:p-10 md:p-14 pb-10 sm:pb-20 md:pb-24 shadow-card relative overflow-hidden">
            ...
            <div wire:key="form-content" class="relative z-10 transition-opacity duration-500"
                ...
                <div class="text-center mb-10">
                    <h2 id="form-heading"
                        ...
                        Form Penjualan</h2>
                    <p class="text-gray-500 font-inter text-sm md:text-base">Silakan isi data dengan lengkap agar kami
                        dapat memberikan estimasi yang akurat.</p>
                </div>
                ...
                <form wire:submit.prevent="submit" class="flex flex-col gap-6">
                        ...
                        <div class="flex flex-wrap gap-4 md:gap-8 bg-gray-50 border @error('kondisi') border-red-500 bg-red-50/20 @else border-gray-200 @enderror rounded-2xl p-4 md:p-5"
                            ...
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <div class="relative flex items-center justify-center">
                                    <input wire:model="kondisi" type="radio" value="baik"
                                        class="peer appearance-none w-5 h-5 border-2 border-gray-300 rounded-full checked:border-black transition-all" />
                                    <div
                                        class="absolute w-2.5 h-2.5 bg-black rounded-full scale-0 peer-checked:scale-100 transition-transform">
                                    </div>
                                </div>
                                <span
                                    class="text-base text-gray-700 group-hover:text-black font-semibold transition-colors">Baik
                                    / Normal</span>
                            </label>
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <div class="relative flex items-center justify-center">
                                    <input wire:model="kondisi" type="radio" value="cukup"
                                        class="peer appearance-none w-5 h-5 border-2 border-gray-300 rounded-full checked:border-black transition-all" />
                                    <div
                                        class="absolute w-2.5 h-2.5 bg-black rounded-full scale-0 peer-checked:scale-100 transition-transform">
                                    </div>
                                ...
                                <span
                                    class="text-base text-gray-700 group-hover:text-black font-semibold transition-colors">Minus
                                    / Lecet</span>
                            </label>
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <div class="relative flex items-center justify-center">
                                    <input wire:model="kondisi" type="radio" value="rusak"
                                        class="peer appearance-none w-5 h-5 border-2 border-gray-300 rounded-full checked:border-black transition-all" />
                                    <div
                                        class="absolute w-2.5 h-2.5 bg-black rounded-full scale-0 peer-checked:scale-100 transition-transform">
                                    </div>
                                ...
                                <span
                                    class="text-base text-gray-700 group-hover:text-black font-semibold transition-colors">Rusak
                                    / Mati Total</span>
                            </label>
                        </div>
                        @error('kondisi')
                    ...
                    <div>
                        <label for="deskripsi"
                            class="block text-sm font-bold uppercase tracking-widest mb-2 text-gray-700 font-public">Detail
                    ...
                    <div x-data="mediaUploader">
                        ...
                        <div class="border-2 border-dashed border-gray-300 hover:border-black rounded-2xl p-6 text-center transition-colors bg-white cursor-pointer relative"
                            ...
                            <div
                                class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 text-black">
                                <i class="fa-solid fa-cloud-arrow-up text-2xl"></i>
                            </div>
                            <h4 class="font-public font-bold text-base text-black mb-1">Klik untuk mengunggah
                                foto/video</h4>
                            <p class="text-xs text-gray-400 font-inter mb-4">Foto max 5MB, Video otomatis dikompres
                                sebelum diunggah</p>
                            <span
                                class="inline-block bg-brand-yellow text-black font-public font-bold uppercase text-xs tracking-wider px-6 py-2.5 rounded-full">Pilih
                                File</span>
                        </div>

                        {{-- Progress Bar Kompresi --}}
                        <div x-show="compressing"
                            class="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-2xl space-y-2" x-cloak>
                            ...
                            <p class="text-xs text-yellow-700 font-inter" x-text="compressionProgress + '% selesai'">
                            </p>
                        </div>
                            ...
                            <div
                                ...
                                <template x-for="(file, index) in processedFiles" :key="index">
                                    <div
                                        ...
                                        <span class="flex-1 truncate font-medium text-black"
        ...
        <div wire:key="success-overlay" x-data="{
            ...
            <div
                ...
                @php
                    ...
                    $waText =
                        "Kode penawaran jual saya di Prokar Elektronik:\n*" .
                        $newServiceCode .
...
@script
    <script>
        Alpine.data('mediaUploader', () => ({
            ...
            refreshGSAP() {
                if (window.updateStickyOverlap) {
                    window.updateStickyOverlap();
                }
            ...
            async handleFiles(event) {
                ...
                for (let i = 0; i < filesToProcess.length; i++) {
                    ...
                    if (file.type.startsWith('video/')) {
                        ...
                        this.compressionMessage = 'Mengompres video "' + file.name + '" (' + (i + 1) + '/' +
