<div class="w-full h-full flex flex-col flex-1">
  ...
  <section class="on-dark hidden lg:flex w-full h-full flex-1 bg-[#0A0A0A] text-[#FCFCFA] flex-col border-l-4 border-[#0A0A0A] rounded-l-3xl overflow-hidden relative min-h-0">
    
    <!-- Loading Overlay for Desktop -->
    <div wire:loading.flex wire:target="updateShipping, selectCourier, updateDeliveryType, updatePaymentOption" class="absolute inset-0 bg-[#0A0A0A]/80 backdrop-blur-xs z-50 rounded-l-3xl flex flex-col items-center justify-center gap-3 p-6 text-center">
          ...
          <div class="border border-[#15803d] bg-[#15803d]/15 rounded-xl p-3 flex items-start gap-3">
            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center justify-between gap-2">
                ...
                <span class="bg-[#15803d] text-white text-[9px] font-bold uppercase tracking-wide px-1.5 py-0.5 rounded">Rp 0 (Gratis)</span>
              </div>
              <p class="text-[11px] text-[#FCFCFA]/70 mt-0.5 font-inter">Toko Prokar Elektronik Jepara (Bebas Ongkir)</p>
            </div>
          </div>
    ...
    <div class="px-6 pb-6 lg:px-7 lg:pb-7 pt-2 shrink-0 bg-[#0A0A0A]">
      <button
        ...
        <span>
          @if ($paymentOption === 'dp')
            Bayar DP ({{ $this->formatRupiah($this->downPaymentAmount()) }}) <i class="fa-solid fa-arrow-right ml-1.5 text-xs"></i>
  ...
  <section class="on-dark lg:hidden bg-[#0A0A0A] text-[#FCFCFA] mx-4 mb-6 p-5 flex flex-col gap-4 rounded-2xl relative">
    ...
    <div wire:loading.flex wire:target="updateShipping, selectCourier, updateDeliveryType, updatePaymentOption" class="absolute inset-0 bg-[#0A0A0A]/80 backdrop-blur-xs z-50 rounded-2xl flex flex-col items-center justify-center gap-2 p-4 text-center">
      ...
      @if ($deliveryType === 'pickup')
        <div class="border border-[#15803d] bg-[#15803d]/15 rounded-xl p-3 flex items-start gap-3">
          ...
          <div class="min-w-0 flex-1">
            <div class="flex items-center justify-between gap-2">
              <span class="font-public font-bold text-xs text-[#FCFCFA]">Ambil Sendiri di Toko</span>
              <span class="bg-[#15803d] text-white text-[9px] font-bold uppercase tracking-wide px-1.5 py-0.5 rounded">Bebas Ongkir</span>
            </div>
