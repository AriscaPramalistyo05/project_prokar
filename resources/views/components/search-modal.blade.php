<div x-data="searchModalState()"
    ...
    <div class="fixed inset-0 z-[99999] pointer-events-none flex items-start justify-center p-4 pt-16 sm:pt-24 md:pt-28">
        <div x-show="isOpen"
             ...
             @click.stop
             class="pointer-events-auto w-full max-w-md md:max-w-xl bg-white border border-slate-200/90 rounded-2xl md:rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col text-slate-800">
            ...
            <div class="p-3.5 sm:p-4 md:p-5 max-h-[60vh] overflow-y-auto scrollbar-hide bg-white">
                ...
                <div x-show="query.trim().length >= 2">
                    <div class="flex items-center justify-between text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2.5 px-1">
                        ...
                        <span x-show="loading" class="text-amber-600 flex items-center gap-1.5 normal-case text-xs font-semibold">
                    ...
                    <div class="flex flex-col gap-0.5">
                        <template x-for="item in topSearches" :key="item.rank">
                            <button type="button"
                                    ...
                                    class="flex items-center justify-between py-2.5 px-3 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-200/60 transition-all group text-left w-full">
