...
<main class="bg-brand-black">
  ...
  <section id="keunggulan" aria-label="Keunggulan layanan jual elektronik" class="section-overlap bg-brand-yellow pt-20 pb-28 md:pt-28 md:pb-40 z-40 overflow-hidden">
...
<script>
  ...
  const overlapSections = gsap.utils.toArray('.section-overlap')
    .filter((section) => section.id !== 'form-penjualan');
