...
<?php $__env->startSection('title', 'Checkout — Keranjang Belanja | Prokar Elektronik'); ?>
<?php $__env->startSection('description', 'Tinjau dan sesuaikan produk di keranjang belanja Anda sebelum melanjutkan ke pengiriman dan pembayaran di Prokar Elektronik.'); ?>
<?php $__env->startSection('robots', 'noindex, nofollow'); ?>
<?php $__env->startSection('theme_color', '#111111'); ?>
<?php $__env->startSection('og_type', 'website'); ?>
<?php $__env->startSection('og_title', 'Keranjang Belanja — Prokar Elektronik'); ?>
<?php $__env->startSection('og_description', 'Tinjau pesanan Anda sebelum melanjutkan ke pembayaran.'); ?>
<?php $__env->startSection('hide_chrome', 'true'); ?> 
...
[$__name, $__params] = $__split('frontend.cart-list', []);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1740406537-0', $__key);
...
?>
      ...
      <div class="mt-auto pt-unit-4 border-t-2 border-primary">
        <a href="<?php echo e(route('products.index')); ?>" class="flex items-center gap-1 font-label-mono text-label-mono text-on-surface-variant hover:text-primary transition-colors uppercase">
...
[$__name, $__params] = $__split('frontend.cart-summary', []);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1740406537-1', $__key);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\project_prokar_vibe_coding\resources\views/pages/cart.blade.php ENDPATH**/ ?>