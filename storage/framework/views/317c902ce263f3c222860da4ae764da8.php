<section class="bg-[#F8F8F8] border-b-2 border-black py-12 md:py-16 px-4">
  <div class="max-w-2xl mx-auto text-center flex flex-col items-center gap-4">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errorMessage): ?>
      <p class="text-xs text-red-600 font-inter mt-1"><?php echo e($errorMessage); ?></p>
    ...
    <div class="flex items-center gap-2 mt-1 no-print">
      ...
      <button
        ...
        class="tab-btn text-[11px] font-inter font-semibold px-3 py-1 border border-gray-300 <?php echo e($activeState === 'ongoing' ? 'active' : 'bg-white text-gray-500'); ?>">
        Sedang Dikerjakan
      </button>
      <button
        type="button"
        wire:click="switchState('done')"
        class="tab-btn text-[11px] font-inter font-semibold px-3 py-1 border border-gray-300 <?php echo e($activeState === 'done' ? 'active' : 'bg-white text-gray-500'); ?>">
        Selesai
      </button>
    </div>
  </div>
</section>
<?php /**PATH D:\laragon\www\project_prokar_vibe_coding\resources\views/livewire/frontend/tracking-search.blade.php ENDPATH**/ ?>