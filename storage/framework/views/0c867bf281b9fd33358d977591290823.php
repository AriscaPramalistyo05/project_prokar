...
<?php $__env->startSection('title', 'Prokar Elektronik – Jual, Beli & Servis Elektronik Bekas Terpercaya di Jepara'); ?>
<?php $__env->startSection('description', 'Prokar Elektronik: jual beli dan servis elektronik bekas berkualitas di Jepara. Kulkas, TV, mesin cuci, AC, dispenser bergaransi dengan harga terjangkau. Teknisi berpengalaman.'); ?>
<?php $__env->startSection('keywords', 'elektronik bekas Jepara, jual kulkas second, servis TV, servis mesin cuci, servis kulkas, AC second, toko elektronik Mlonggo, jual beli elektronik, Prokar Elektronik'); ?>
<?php $__env->startSection('canonical', 'https://prokarelektronik.com/'); ?>
<?php $__env->startSection('og_title', 'Prokar Elektronik – Jual, Beli & Servis Elektronik Bekas Terpercaya'); ?>
<?php $__env->startSection('og_description', 'Toko elektronik bekas berkualitas di Jepara. Jual, beli, dan servis TV, kulkas, mesin cuci, AC, dispenser bergaransi dengan harga terjangkau.'); ?>
<?php $__env->startSection('og_url', 'https://prokarelektronik.com/'); ?>
<?php $__env->startSection('og_image', 'https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/mfbi92py_expires_30_days.png'); ?>
    ...
    <section id="hero" class="bg-white w-full overflow-hidden">
      ...
      <nav aria-label="Kategori produk" class="max-w-6xl mx-auto px-6 md:px-16 pt-6">
        <ul class="flex flex-row gap-2 md:gap-5 items-end justify-start lg:justify-center list-none m-0 p-0 overflow-x-auto scrollbar-hide">
          <li class="shrink-0"><a href="<?php echo e(route('products.index')); ?>?kategori=kulkas" class="cat-card shadow-soft">
              <div class="bg-gray-50 w-full"><img src="<?php echo e(asset('assets/images/kulkas0.png')); ?>" class="w-full h-[120px] md:h-[185px] lg:h-[130px] object-cover" alt="Kulkas bekas berkualitas" loading="lazy" /></div>
          ...
          <li class="shrink-0"><a href="<?php echo e(route('products.index')); ?>?kategori=tv" class="cat-card cat-card--tall shadow-soft">
              <div class="bg-gray-50 w-full"><img src="<?php echo e(asset('assets/images/tv0.png')); ?>" class="w-full h-[140px] md:h-[215px] lg:h-[155px] object-cover" alt="TV bekas berkualitas" loading="lazy" /></div>
          ...
          <li class="shrink-0"><a href="<?php echo e(route('products.index')); ?>?kategori=mesin-cuci" class="cat-card shadow-soft">
              <div class="bg-gray-50 w-full"><img src="<?php echo e(asset('assets/images/mesin-cuci0.png')); ?>" class="w-full h-[120px] md:h-[185px] lg:h-[130px] object-cover" alt="Mesin Cuci bekas berkualitas" loading="lazy" /></div>
          ...
          <li class="shrink-0"><a href="<?php echo e(route('products.index')); ?>?kategori=ac" class="cat-card cat-card--tall shadow-soft">
              <div class="bg-gray-50 w-full"><img src="<?php echo e(asset('assets/images/ac0.png')); ?>" class="w-full h-[140px] md:h-[215px] lg:h-[155px] object-cover" alt="AC bekas berkualitas" loading="lazy" /></div>
          ...
          <li class="shrink-0"><a href="<?php echo e(route('products.index')); ?>?kategori=dispenser" class="cat-card shadow-soft">
              <div class="bg-gray-50 w-full"><img src="<?php echo e(asset('assets/images/dispenser0.png')); ?>" class="w-full h-[120px] md:h-[185px] lg:h-[130px] object-cover" alt="Dispenser bekas berkualitas" loading="lazy" /></div>
          ...
          <li class="shrink-0"><a href="<?php echo e(route('products.index')); ?>?kategori=microwave" class="cat-card cat-card--tall shadow-soft">
              <div class="bg-gray-50 w-full"><img src="<?php echo e(asset('assets/images/microwave0.png')); ?>" class="w-full h-[140px] md:h-[215px] lg:h-[155px] object-cover" alt="Microwave bekas berkualitas" loading="lazy" /></div>
        ...
        <div class="flex flex-col gap-8">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 lg:gap-8">
            <a href="https://wa.me/6289504841279" target="_blank" rel="noopener noreferrer" class="relative overflow-hidden border-[3px] border-black h-[240px] md:h-[280px] lg:h-[320px] group bg-black">
              <img src="<?php echo e(asset('assets/images/service-tv.jpg')); ?>" alt="Service TV" class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
            ...
            <a href="https://wa.me/6289504841279" target="_blank" rel="noopener noreferrer" class="relative overflow-hidden border-[3px] border-black h-[240px] md:h-[280px] lg:h-[320px] group bg-black">
              <img src="<?php echo e(asset('assets/images/service-mesin-cuci.jpg')); ?>" alt="Service Mesin Cuci" class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
              <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex justify-start items-end p-6 md:p-8">
            ...
            <a href="https://wa.me/6289504841279" target="_blank" rel="noopener noreferrer" class="relative overflow-hidden border-[3px] border-black h-[240px] md:h-[280px] lg:h-[320px] group bg-black">
              <img src="<?php echo e(asset('assets/images/service-kulkas.jpg')); ?>" alt="Service Kulkas" class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
              <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex justify-start items-end p-6 md:p-8">
          ...
          <div id="onsale-track" class="flex gap-4 pb-2" role="list">
            ...
            <article class="onsale-card bg-stone-50 border border-[#e8e8e8] p-2 md:p-2 lg:p-3 flex flex-col" role="listitem" data-id="1" data-name="Smart TV 4K UHD 55 inch" data-price="Rp 5.499.000" data-oldprice="Rp 5.999.000" data-badge="SALE" data-img="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/burs3wxx_expires_30_days.png" data-colors='[]' data-rating="4.5" data-reviews="128">
              <div class="relative w-full mb-2 md:mb-2 lg:mb-3">
                <a href="<?php echo e(route('products.show', 'smart-tv-4k-uhd-55-inch')); ?>" class="block">
              ...
              <div class="w-full px-1">
                <a href="<?php echo e(route('products.show', 'smart-tv-4k-uhd-55-inch')); ?>"><h3 class="text-[12px] md:text-[11px] lg:text-sm font-bold uppercase leading-tight line-clamp-2">Smart TV 4K UHD 55 inch</h3></a>
            ...
            <article class="onsale-card bg-stone-50 border border-[#e8e8e8] p-2 md:p-2 lg:p-3 flex flex-col" role="listitem" data-id="2" data-name="Blender Multifungsi" data-price="Rp 450.000" data-oldprice="Rp 550.000" data-badge="SALE" data-img="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/cilcgsan_expires_30_days.png" data-colors='[]' data-rating="4.3" data-reviews="87">
              <div class="relative w-full mb-2 md:mb-2 lg:mb-3">
                <a href="<?php echo e(route('products.show', 'blender-multifungsi')); ?>" class="block">
              ...
              <div class="w-full px-1">
                <a href="<?php echo e(route('products.show', 'blender-multifungsi')); ?>"><h3 class="text-[12px] md:text-[11px] lg:text-sm font-bold uppercase leading-tight line-clamp-2">Blender Multifungsi</h3></a>
            ...
            <article class="onsale-card bg-stone-50 border border-[#e8e8e8] p-2 md:p-2 lg:p-3 flex flex-col" role="listitem" data-id="3" data-name="AC Split 1 PK Low Watt" data-price="Rp 3.450.000" data-oldprice="Rp 3.800.000" data-badge="SALE" data-img="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/cs9jkbf3_expires_30_days.png" data-colors='[]' data-rating="4.6" data-reviews="56">
              <div class="relative w-full mb-2 md:mb-2 lg:mb-3">
                <a href="<?php echo e(route('products.show', 'ac-split-1-pk-low-watt')); ?>" class="block">
              ...
              <div class="w-full px-1">
                <a href="<?php echo e(route('products.show', 'ac-split-1-pk-low-watt')); ?>"><h3 class="text-[12px] md:text-[11px] lg:text-sm font-bold uppercase leading-tight line-clamp-2">AC Split 1 PK Low Watt</h3></a>
...
[$__name, $__params] = $__split('frontend.testimoni');
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3281396178-0', $__key);
...
[$__name, $__params] = $__split('frontend.faq');
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3281396178-1', $__key);
  ...
  <div id="cart-modal" role="dialog" aria-modal="true" aria-labelledby="cart-modal-title">
    <div id="cart-step-select">
      ...
      <div class="px-4 pb-4 pt-4 border-t border-gray-100 mt-4">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="block text-center text-xs text-gray-500 mt-2 hover:text-black font-inter underline">Lihat Detail Produk</a>
      </div>
    </div>
    <div id="cart-step-added" style="display:none; flex-direction:column;">
      ...
      <div class="px-4 pt-5 pb-4 flex flex-col gap-3 mt-auto">
        ...
        <a href="<?php echo e(route('cart')); ?>" class="w-full block text-center bg-black text-white font-bold text-sm uppercase tracking-wider py-3 hover:bg-gray-800 transition-colors font-public">LIHAT KERANJANG</a>
        <a href="<?php echo e(route('checkout.address')); ?>" class="w-full block text-center bg-[#FFCC00] text-black font-bold text-sm uppercase tracking-wider py-3 hover:bg-[#f0c000] transition-colors font-public">CHECKOUT</a>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\project_prokar_vibe_coding\resources\views/pages/home.blade.php ENDPATH**/ ?>