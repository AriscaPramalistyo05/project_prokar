        ...
        <div class="grid grid-cols-2 tablet:grid-cols-3 md:grid-cols-4 gap-3 md:gap-0 md:items-stretch" role="list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <article class="flex flex-col bg-[#F3F3F3] md:bg-white md:mx-4 md:mb-8 border border-transparent md:border-0"
                    ...
                    <a href="<?php echo e(route('products.show', $p['slug'])); ?>"
                        aria-label="Lihat detail <?php echo e($p['name']); ?>" class="block">
                        <div class="card-bg-img relative"
                            style="background-image: url('<?php echo e($p['image']); ?>');">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p['on_sale']): ?>
                        ...
                        <div class="flex flex-col md:flex-1 md:ml-4">
                            ...
                            <div class="flex items-start mb-1 md:mb-2 md:h-8">
                                <div class="inline-block bg-[#0356FF] md:bg-emerald-500 py-0.5 md:py-1 px-2 md:px-3 min-w-[60px] text-center">
                                    <span class="text-white font-bold text-[9px] md:text-xs"><?php echo e($p['condition']); ?></span>
                                </div>
                            </div>
                            <div class="md:mt-auto">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p['original_price']): ?>
                                    <p class="text-[#7E7576] md:text-gray-500 text-[10px] md:text-sm line-through leading-tight min-h-[1rem] md:h-5">
                                        Rp <?php echo e(number_format($p['original_price'], 0, ',', '.')); ?>
...
<?php /**PATH D:\laragon\www\project_prokar_vibe_coding\resources\views/livewire/frontend/product-grid.blade.php ENDPATH**/ ?>