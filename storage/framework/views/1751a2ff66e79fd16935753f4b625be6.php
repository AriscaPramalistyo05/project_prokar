...
<?php $__env->startSection('title', 'Jual Elektronik Bekas – Penawaran Terbaik | Prokar Elektronik'); ?>
<?php $__env->startSection('description', 'Jual elektronik bekas Anda dengan mudah dan cepat di Prokar Elektronik. Penilaian transparan, jemput gratis ke lokasi, dan pembayaran langsung di tempat.'); ?>
<?php $__env->startSection('keywords', 'jual elektronik bekas, jual TV bekas, jual kulkas bekas, jual mesin cuci bekas, jual AC bekas, jual elektronik Jepara, Prokar Elektronik'); ?>
<?php $__env->startSection('canonical', 'https://prokarelektronik.com/jual'); ?>
<?php $__env->startSection('og_url', 'https://prokarelektronik.com/jual'); ?>
<?php $__env->startSection('og_title', 'Jual Elektronik Bekas – Penawaran Terbaik | Prokar Elektronik'); ?>
<?php $__env->startSection('og_description', 'Jual elektronik bekas Anda dengan mudah dan cepat. Penilaian transparan, jemput gratis ke lokasi, dan pembayaran langsung di tempat.'); ?>
<?php $__env->startSection('twitter_title', 'Jual Elektronik Bekas – Penawaran Terbaik | Prokar Elektronik'); ?>
<?php $__env->startSection('twitter_description', 'Jual elektronik bekas Anda dengan mudah dan cepat. Penilaian transparan, jemput gratis, dan pembayaran langsung.'); ?>
...
[$__name, $__params] = $__split('frontend.sell-form', []);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-816525983-0', $__key);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\project_prokar_vibe_coding\resources\views/pages/sell.blade.php ENDPATH**/ ?>