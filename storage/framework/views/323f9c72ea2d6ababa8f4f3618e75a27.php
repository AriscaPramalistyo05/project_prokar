...
<?php $__env->startSection('title', 'Smart TV 4K UHD 55 Inch – Kondisi Seperti Baru | Prokar Elektronik'); ?>
<?php $__env->startSection('description', 'Beli Smart TV 4K UHD 55 Inch bekas berkualitas di Prokar Elektronik. Kondisi seperti baru, sudah dicek teknisi, fitur Smart TV lengkap, bergaransi. Harga Rp 5.499.000.'); ?>
<?php $__env->startSection('keywords', 'Smart TV 4K UHD 55 inch, TV bekas, TV second berkualitas, beli TV bekas Jepara, Prokar Elektronik'); ?>
<?php $__env->startSection('canonical', 'https://prokarelektronik.com/produk/smart-tv-4k-uhd-55-inch'); ?>
<?php $__env->startSection('og_type', 'product'); ?>
<?php $__env->startSection('og_url', 'https://prokarelektronik.com/produk/smart-tv-4k-uhd-55-inch'); ?>
<?php $__env->startSection('og_title', 'Smart TV 4K UHD 55 Inch – Kondisi Seperti Baru | Prokar Elektronik'); ?>
<?php $__env->startSection('og_description', 'Beli Smart TV 4K UHD 55 Inch bekas berkualitas. Kondisi seperti baru, sudah dicek teknisi, fitur Smart TV lengkap, bergaransi.'); ?>
<?php $__env->startSection('og_image', 'https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/burs3wxx_expires_30_days.png'); ?>
<?php $__env->startSection('twitter_title', 'Smart TV 4K UHD 55 Inch – Kondisi Seperti Baru | Prokar Elektronik'); ?>
<?php $__env->startSection('twitter_description', 'Beli Smart TV 4K UHD 55 Inch bekas berkualitas. Kondisi seperti baru, sudah dicek teknisi, bergaransi.'); ?>
<?php $__env->startSection('twitter_image', 'https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/burs3wxx_expires_30_days.png'); ?>
<?php $__env->startSection('body_class', 'bg-white'); ?>

<?php $__env->startSection('product_price_amount', '5499000'); ?>
<?php $__env->startSection('product_price_currency', 'IDR'); ?>
<?php $__env->startSection('product_availability', 'in stock'); ?>
<?php $__env->startSection('product_condition', 'used'); ?>
...
<main class="px-4 md:px-[68px] mb-10 md:mb-14">
    ...
    <nav aria-label="Breadcrumb" class="sr-only">
      <ol>
        ...
        <li><a href="<?php echo e(route('products.index')); ?>?kategori=televisi">Televisi</a></li>
    ...
    <nav aria-label="Breadcrumb" class="flex items-center gap-1.5 mb-5 md:mb-7 flex-wrap">
      <a href="<?php echo e(route('home')); ?>" class="text-[11px] md:text-xs text-gray-400 hover:text-gray-600 transition-colors">Home</a>
      <span class="text-[11px] md:text-xs text-gray-300" aria-hidden="true">/</span>
      <a href="<?php echo e(route('products.index')); ?>" class="text-[11px] md:text-xs text-gray-400 hover:text-gray-600 transition-colors">Produk</a>
      <span class="text-[11px] md:text-xs text-gray-300" aria-hidden="true">/</span>
      <a href="<?php echo e(route('products.index')); ?>?kategori=televisi"
    ...
    <article class="flex flex-col md:flex-row gap-6 md:gap-10 lg:gap-14" itemscope
      ...
      <div class="w-full md:flex-1 flex flex-col">
        ...
        <div class="flex flex-col gap-2.5 mt-auto">
          <button type="button" class="btn-primary" onclick="window.location.href='<?php echo e(route('cart')); ?>'">
            <i class="fa-solid fa-bolt text-sm" aria-hidden="true"></i>
            Beli Sekarang
          </button>
          <button type="button" class="btn-secondary" onclick="window.location.href='<?php echo e(route('checkout.address')); ?>'">
    ...
    <section aria-labelledby="produk-serupa-heading" class="mt-14 md:mt-20">
      ...
      <div class="grid grid-cols-2 tablet:grid-cols-2 md:grid-cols-4 gap-3 md:gap-0 md:items-stretch"
        ...
        <article class="flex flex-col bg-[#F3F3F3] md:bg-white md:mx-4 md:mb-8 border border-transparent md:border-0"
          ...
          <a href="<?php echo e(route('products.show', 'kulkas-2-pintu-inverter')); ?>" aria-label="Lihat detail Kulkas 2 Pintu Inverter" class="block">
            <img
              src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/lfo9hyrd_expires_30_days.png"
        ...
        <article class="flex flex-col bg-[#F3F3F3] md:bg-white md:mx-4 md:mb-8 border border-transparent md:border-0"
          style="box-shadow: 0px 2px 4px #0000001a" role="listitem">
          <a href="<?php echo e(route('products.show', 'mesin-cuci-front-loading')); ?>" aria-label="Lihat detail Mesin Cuci Front Loading" class="block">
            <img
              src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/i79fn9am_expires_30_days.png"
        ...
        <article class="flex flex-col bg-[#F3F3F3] md:bg-white md:mx-4 md:mb-8 border border-transparent md:border-0"
          style="box-shadow: 0px 2px 4px #0000001a" role="listitem">
          <a href="<?php echo e(route('products.show', 'ac-split-1-pk-low-watt')); ?>" aria-label="Lihat detail AC Split 1 PK Low Watt" class="block">
        ...
        <article class="flex flex-col bg-[#F3F3F3] md:bg-white md:mx-4 md:mb-8 border border-transparent md:border-0"
          style="box-shadow: 0px 2px 4px #0000001a" role="listitem">
          <a href="<?php echo e(route('products.show', 'microwave-digital-20l')); ?>" aria-label="Lihat detail Microwave Digital 20L" class="block">
            <img
              src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/V9M2mMKXM6/3mwa74uz_expires_30_days.png"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\project_prokar_vibe_coding\resources\views/pages/product-detail.blade.php ENDPATH**/ ?>